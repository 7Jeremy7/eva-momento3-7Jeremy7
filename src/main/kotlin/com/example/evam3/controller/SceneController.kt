...
class SceneController {
    ...
    @PutMapping
    fun update (@RequestBody modelo:Scene):ResponseEntity<Scene>{
        return ResponseEntity(sceneService.update(modelo), HttpStatus.OK)
    }
    @PatchMapping
    fun updateDescription (@RequestBody scene: Scene):ResponseEntity<Scene>{
        return ResponseEntity(sceneService.updateDescription(scene), HttpStatus.OK)
    }
